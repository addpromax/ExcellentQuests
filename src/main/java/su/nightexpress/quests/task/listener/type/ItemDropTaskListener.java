 ...
 * 丢弃物品任务监听器
 */
public class ItemDropTaskListener extends TaskListener<ItemStack, AdapterFamily<ItemStack>> {

    public ItemDropTaskListener(@NotNull QuestsPlugin plugin, @NotNull TaskManager manager, @NotNull TaskType<ItemStack, AdapterFamily<ItemStack>> taskType) {
